...
const FormShift = ({ dataEntry, saveData }) => {
  ...
  return (
    <Form onSubmit={sendData}>
      ...
      <Form.Group className="mb-3" controlId="formBasicType">
        ...
        <Form.Control type="text" placeholder="Ingrese turno" name="type" onChange={handleInputChange} value={data ? data.type : ''} autoFocus />
      </Form.Group>
      <br />
