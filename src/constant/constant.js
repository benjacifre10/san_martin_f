...
export const LanguageTitles = {
  titles: ["Name", "Surname", "Identitynumber", "Active", "Role", "Type", "Email", "Code", "Degree", "State", "Professor", "Shift", "Pursuetype", "Credithours", "Days", "From", "To"],
  titulos: ["Nombre", "Apellido", "Dni", "Estado", "Rol", "Tipo", "Email", "Codigo", "Carrera", "Estado", "Profesor", "Turno", "Modalidad", "Carga Hs", "Dias", "Desde", "Hasta"],
};
